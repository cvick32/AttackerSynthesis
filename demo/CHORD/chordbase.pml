...
proctype node (byte n) {
   ...
   :: (n == 3 || n == 5) &&
      succ[n] == 9 && n != 0 -> 
         atomic { joinCheck(n,0); } atomic { join(n,0); reconcile(n) }
   :: (n == 0 || n == 3 || n == 5) &&
      succ[n] == 9 && n != 1 -> 
   ...
   :: (n == 0 || n == 5) &&
      succ[n] == 9 && n != 3 -> 
         atomic { joinCheck(n,3); } atomic { join(n,3); reconcile(n) }
   :: (n == 0 || n == 3 || n == 5) &&
      succ[n] == 9 && n != 4 -> 
         atomic { joinCheck(n,4); } atomic { join(n,4); reconcile(n) }
   :: (n == 0 || n == 3) &&
      succ[n] == 9 && n != 5 -> 
         atomic { joinCheck(n,5); } atomic { join(n,5); reconcile(n) }

   :: succ[n] != 9 -> atomic { stabilizeCheck(n); }
                      atomic { stabilize(n); reconcile(n); } 
                      atomic { flush(succ[n]); notified(succ[n],n) }

   :: (n == 0 || n == 3 || n == 5) &&   /* atomicity is modeling assump. */
